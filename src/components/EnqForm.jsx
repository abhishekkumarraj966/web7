...
const EnqForm = () => {
  ...
  return (
    <AppLayout>
      <section id="contact">
        <div className="bg-[#F1C6D5] text-[#000] h-auto mb-5 rounded-md">
            ...
            <form>
              <AppLayout>
                ...
                <div className="flex items-center justify-center lg:justify-start lg:ml-[27px] mt-4">
                  ...
                  <label
                    htmlFor="terms"
                    className="text-[20px] mb-[8px] text-[#000] lg:text-[30px] lg:py-6  sm:py-4 sm:mx-4"
                  >
                    I agree to the{" "}
                    <a
                      href="/terms"
                    ...
                    <div className=" p-4 rounded-md">
                      <div className="sm:ml-10">
                        <button
                          ...
                          className="bg-[#FF9796] text-black px-4 py-2 rounded-md hover:bg-[#000] hover:text-white focus:outline-none focus:shadow-outline-blue w-28 h-10"
